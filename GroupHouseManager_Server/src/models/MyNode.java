...
public class MyNode {
	...
	public MyNode(IOwnership data) throws SAXException, IOException, ParserConfigurationException, TransformerFactoryConfigurationError, TransformerException {
		long id = FileManager.readIdFile() + 1;
		FileManager.writeIdFile(id);
		this.id = (int) id;
		this.data = data;
