...
public class GridSystem {
	...
	private static final int ROWS_NUMBER = 12;
	private static final double DEFAULT_ROW_WIDTH = 0.5;
	...
	public GridSystem(Container component) {
		...
		generateBasicGridX(component);	
		generateBasicGridY(component);
	}

	private void generateBasicGridX(Container component){
	...
	private void generateBasicGridY(Container component){
		constraints.weighty = DEFAULT_ROW_WIDTH;
	...
	public GridBagConstraints insertComponentRemaster(int row, int column, int width, int height){
		constraints.gridy = row;
		constraints.gridx = column;
		constraints.gridwidth = width;
